    ...
    <div class="content">
      <ul class="classlist">
        <table width="80%" align="center">
          ...
          <tr>
            <td align="center"><fmt:formatDate value="${news.ncreateDate}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
          ...
          <tr>
            <td colspan="2"> 　
              ${news.ncontent} <img width="200px" height="400px" src="/test?picname=${news.npicPath}" alt="">
            </td>
          </tr>
          <tr>
            <td colspan="2"><hr />
      ...
      <c:if test="${param.sucCode==100}">
        <script type="text/javascript">
          alert("评论成功！");
        </script>
      </c:if>
      <ul class="classlist">
        <form action="/add_comment" method="post" onsubmit="return check()">
