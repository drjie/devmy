    ...
    <table class="table table-hover">
        ...
        <c:forEach items="${dishesList}" var="dish">
            <tr>
                ...
                <td><a href="javascript:void(0)" rel = "${dish.id}" class = "addshopcar">加入购物车</a> <a href="/dish/praise?dishId=${dish.id}">点赞</a></td>
            </tr>
        </c:forEach>
...
<script type="text/javascript">
    $(function(){
        $(".addshopcar").click(function(){
            let dishId = $(this).attr("rel");
            $.post('/shopcar/add',{dishId:dishId},function (data){
                if(data == '0'){
                    alert("成功加入购物车！");
                }
            });
